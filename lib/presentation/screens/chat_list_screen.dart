...
import 'package:pai_app/widgets/chat_list_widgets.dart';
...
class _ChatListScreenState extends ConsumerState<ChatListScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: isSelectionMode
          ? _buildSelectionBottomBar(theme, colorScheme)
          : null,
    );
  }
  ...
  PreferredSizeWidget _buildAppBar(ThemeData theme, ColorScheme colorScheme) {
    if (isSelectionMode) {
      return AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.select_all), onPressed: _selectAllChats),
        ],
      );
    }
  ...
  Future<void> _loadChats() async {
    ...
    allChats = [
      ...
      ChatItem(
        ...
        subtitle: null,
        avatarUrl:
            'https://images.unsplash.com/photo-1494790108755-2616b612b6f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
      ...
      ChatItem(
        ...
        subtitle: null,
        avatarUrl:
            'https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
        lastMessage: 'Imagen',
  ...
  void _filterChats() {
    filteredChats = allChats.where((chat) {
      ...
      if (selectedChatTypes.isNotEmpty &&
          !selectedChatTypes.contains(chat.chatType)) {
        return false;
      }
...
class _ArchivedChatsScreenState extends State<ArchivedChatsScreen> {
  ...
  void _unarchiveChat(ChatItem chat) {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Chat restaurado')));
  }
