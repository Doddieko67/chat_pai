import 'package:pai_app/presentation/screens/chat_context/chat_context_screen.dart';
import 'package:pai_app/riverpod/auth_provider.dart';
import 'package:pai_app/presentation/screens/chat_screen.dart';
import 'package:pai_app/presentation/screens/profile_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flutter_dotenv/flutter_dotenv.dart';
import 'package:pai_app/riverpod/theme_provider.dart';
import 'package:pai_app/theme/theme.dart';
import 'package:pai_app/presentation/screens/login_screen.dart';
import 'package:pai_app/presentation/screens/chat_list_screen.dart';
import 'package:pai_app/presentation/screens/therapist_list_screen.dart';
import 'package:pai_app/presentation/screens/therapist_profile_screen.dart';
import 'package:pai_app/presentation/screens/chat_settings_screen.dart';
...
Future<void> main() async {
  ...
  // Intentar inicializar Firebase, si falla usar modo development
  ...
  try {
    ...
    print('⚠️ Firebase no disponible, usando modo development: $e');
  ...
  runApp(ProviderScope(
    overrides: [
      // Pasar el estado de Firebase como provider
...
class MyApp extends ConsumerWidget {
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        if (settings.name?.startsWith('/therapist_profile/') == true) {
          ...
          return MaterialPageRoute(
            builder: (context) =>
                TherapistProfileScreen(therapistId: therapistId),
          );
        }
  ...
  Therapist _getMockTherapist(String id) {
    return Therapist(
      ...
      isVerified: true,
      imageUrl:
          'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80',
      description:
          'Especialista en trastornos de ansiedad y depresión con enfoque cognitivo-conductual.',
...
class _AppShellState extends ConsumerState<AppShell> {
  ...
  final List<ScreenInfo> screens = [
    ScreenInfo(title: 'Chats', icon: Icons.chat, widget: ChatListScreen()),
    ScreenInfo(
      title: 'Terapeutas',
          ...
          IconButton(
            ...
            onPressed: () {
              ref
                  ...
                  .state = ref.read(themeModeProvider) == ThemeModeType.light
                  ? ThemeModeType.dark
                  : ThemeModeType.light;
            },
          ),
      ...
      return FloatingActionButton.extended(
        onPressed: () {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text('Filtros de terapeutas')));
        },
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text('Conectando con IA...')));
              },
            ),
          ],
        ),
  ...
  void _showDebugInfo() {
    ...
    final user = authState.user;
    final isFirebaseMode = ref.read(firebaseInitializedProvider);
    
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Debug - Info del Sistema'),
        content: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Modo: ${isFirebaseMode ? '🔥 Firebase' : '🧪 Development'}',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: isFirebaseMode ? Colors.orange : Colors.blue,
                ),
              ),
              SizedBox(height: 12),
              if (user != null) ...[
                ...
                SizedBox(height: 4),
                Text('Es Terapeuta: ${user.isTherapist ? 'Sí' : 'No'}'),
              ] else
              ...
              if (!isFirebaseMode) ...[
                ...
                SizedBox(height: 4),
                Text('Total: ${MockAuthService.getRegisteredUsers().length}'),
              ],
            ],
          ),
        ),
...
class ScreenInfo {
  ...
  ScreenInfo({required this.title, required this.icon, required this.widget});
}
