...
class ChatAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (chatType == ChatType.group &&
        groupMemberAvatars != null &&
        groupMemberAvatars!.length > 1) {
        ...
        children: [
          ...
          Positioned(
            ...
            child: CircleAvatar(
              ...
              backgroundImage:
                  groupMemberAvatars!.length > 1 &&
                      groupMemberAvatars![1].isNotEmpty
                  ? NetworkImage(groupMemberAvatars![1])
                  : null,
              child:
                  groupMemberAvatars!.length <= 1 ||
                      groupMemberAvatars![1].isEmpty
                  ? Icon(
                      Icons.person,
                      size: size * 0.2,
...
class OnlineIndicator extends StatelessWidget {
  ...
  const OnlineIndicator({Key? key, required this.status, this.size = 16})
    : super(key: key);
...
class UnreadBadge extends StatelessWidget {
  ...
  const UnreadBadge({Key? key, required this.count, this.isMuted = false})
    : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isMuted ? colorScheme.outline : colorScheme.primary;

    final textColor = isMuted ? colorScheme.surface : colorScheme.onPrimary;
    ...
    return Row(
      children: [
        if (type != MessageType.text) ...[
          Icon(_getMessageTypeIcon(), size: 16, color: colorScheme.primary),
          SizedBox(width: 4),
        ],
        Expanded(
          child: Text(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Spacer(),
              TextButton(onPressed: onClearFilters, child: Text('Limpiar')),
            ],
          ),
