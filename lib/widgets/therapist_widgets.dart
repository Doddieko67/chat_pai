        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  StarRating(rating: therapist.rating, size: 16),
                  SizedBox(width: 4),
                  Text(
                    '${therapist.rating}',
                    style: theme.textTheme.bodySmall?.copyWith(
                  ...
                  SizedBox(width: 4),
                  Text(therapist.experience, style: theme.textTheme.bodySmall),
                ],
              ),
        ...
        children: [
          ...
          Wrap(
            ...
            children: availabilities.map((availability) {
              ...
              return SpecialtyChip(
                ...
                isSelected: isSelected,
                onTap: () =>
                    onAvailabilityChanged(isSelected ? '' : availability),
              );
            }).toList(),
          ),
          ...
          Row(
            children: [
              ...
              SizedBox(width: 8),
              StarRating(rating: minRating, size: 16),
            ],
          ),
